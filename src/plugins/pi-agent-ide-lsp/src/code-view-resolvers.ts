...
import { type LspManager, readLspFileGraph, readLspSymbolBody, readLspSymbolGraph } from "./lsp/index.js";
...
function optionalSelector(selector: readonly string[] | undefined): Pick<CodeViewReadRequest, "selector">
{

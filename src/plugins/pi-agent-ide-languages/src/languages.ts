...
export const LANGUAGES: readonly LanguageDefinition[] = [
  ...
  language("dart", "Dart", [".dart"], ["pubspec.yaml", "analysis_options.yaml"]),
  language(
    "powershell",
    "PowerShell",
    [".ps1", ".psm1", ".psd1"],
  ...
  language("r", "R", [".r"], ["DESCRIPTION", ".lintr", ".Rprofile"]),
  language("scala", "Scala", [".scala", ".sc"], ["build.sbt", "project.scala", ".scalafmt.conf"]),
  language("elixir", "Elixir", [".ex", ".exs"], ["mix.exs", ".formatter.exs"]),
  language("zig", "Zig", [".zig", ".zon"], ["build.zig", "build.zig.zon", "zls.json"]),
  language("julia", "Julia", [".jl"], ["Project.toml", ".JuliaFormatter.toml"]),
  language("vue", "Vue", [".vue"], ["package.json"]),
  language("svelte", "Svelte", [".svelte"], ["svelte.config.js", "svelte.config.ts"]),

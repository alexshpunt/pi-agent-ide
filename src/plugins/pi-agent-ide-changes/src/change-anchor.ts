...
export function createChangeAnchorRegistration(executor: GitCommandExecutor): ChangeAnchorRegistration
{
    const inspect = async (context: TextAnchorResolverContext): Promise<ChangeInspection | undefined> =>
    {
    ...
    return {
        ...
        async tryResolve(value, context)
        {
            ...
            try
            {
                ...
                const group = inspection.status === "applicable"

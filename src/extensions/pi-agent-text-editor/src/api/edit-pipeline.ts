...
export type TextEditHandler = (
    state: TextEditState,
) => TextEditState | Promise<TextEditState>;
...
export function isTextEditHandlerRegistration(value: unknown): value is TextEditHandlerRegistration
{

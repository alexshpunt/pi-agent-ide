...
export const deleteSchema = Type.Object({
    ...
    start: Type.Optional(Type.String({ description: "Registered text anchor selecting the first line to delete" })),
    end: Type.Optional(Type.String({ description: "Registered text anchor selecting the last line to delete" })),
...
export const deleteMutationTool: TextMutationToolRegistration<typeof deleteSchema> = {
    ...
    pair: ["start", "end"],
    mutate: async (context, params: DeleteParams) =>
    {

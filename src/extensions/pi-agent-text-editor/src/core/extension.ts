...
import { READ_API_VERSION, READ_PROTOCOL, type ReadPluginApi } from "pi-agent-read/api/plugin-protocol";
...
import { isTextPostEditHandlerRegistrationRequest, TEXT_EDITOR_POST_EDIT_REGISTER_EVENT } from "#src/api/post-edit.js";
...
export default async function registerTextEditorCore(pi: ExtensionAPI): Promise<ReturnType<typeof createTextEditorCore>>
{
        ...
        pi.registerTool(
            createTextTool(
                ...
                () =>
                    ...
                    ].filter((guideline): guideline is string => guideline !== undefined).join("\n\n") || undefined,

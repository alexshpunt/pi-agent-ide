...
export class BatchExecutionJournal
{
    ...
    {
        this.entries = new Map(callIds.map((callId) => [callId, { callId, state: "pending", recovered: false }]));
    }
    ...
    {
        this.transition(callId, { state: "blocked", result, blockedDetails: details, recovered: false });
    }

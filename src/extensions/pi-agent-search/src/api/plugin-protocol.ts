...
const functionSchema = Type.Unsafe<(...args: never[]) => unknown>({ type: "Function" });
...
export function isSearchPluginRegistrationRequest(value: unknown): value is SearchPluginRegistrationRequest
{

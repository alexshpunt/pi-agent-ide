...
export function isContentConverterRegistrationRequest(
  ...
  return (
    safeCheck(registrationRequestSchema, value) &&
    safeEvaluate(() =>
      isContentConverterRegistration((value as ContentConverterRegistrationRequest).registration),
    )
  );
}

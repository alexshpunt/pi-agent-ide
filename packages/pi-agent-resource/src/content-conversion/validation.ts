...
export function isContentConverterRegistration(
  value: unknown,
): value is ContentConverterRegistration {
  ...
  return safeEvaluate(() => {
    ...
    return (
      isContentTarget(registration.target) &&

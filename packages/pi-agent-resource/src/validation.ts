...
export function isAgentContent(value: unknown): value is AgentContent
{
    ...
    return safeEvaluate(() =>
        (value as readonly Record<PropertyKey, unknown>[]).every((block) =>
            block.type !== "text"
...
export function isResource(value: unknown): value is Resource
{
    ...
    return safeEvaluate(() =>
    {
        ...
        const readIsValid = !("read" in resource) || typeof resource.read === "function";
        const writeIsValid = !("write" in resource) || typeof resource.write === "function";

...
export { type PresentedTextRow, renderPresentedTextRows, type TextChangeMarker } from "./presented-text.js";
...
export { createTextContentConverter, isTextualMediaType, textFromAgentContent } from "./text-converter.js";
